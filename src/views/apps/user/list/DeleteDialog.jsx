...
const DeleteDialog = ({ open, handleClose, rowId, getList }) => {
  const handleDelete = () => {
    ...
    const url = `${process.env.API}/consolidated-data/delete`
  ...
  return (
    <Dialog fullWidth maxWidth='xs' open={open} onClose={handleClose}>
      <DialogContent className='flex items-center flex-col text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
        ...
        <Typography variant='h5'>Are you sure you want to delete this record? This action cannot be undone.</Typography>
      </DialogContent>
